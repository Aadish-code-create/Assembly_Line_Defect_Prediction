""" Project: Assembly Line Defect Prediction
    Function: Filter categorical data to match sampled Ids
    Objective: Keep only the same parts we already sampled in numeric """

import pandas as pd

INPUT_FILE = "data/raw/train_categorical.csv"
OUTPUT_FILE = "data/processed/train_categorical_sample.csv"
IDS_FILE = "data/processed/sampled_ids.csv"

CHUNK_SIZE = 100_000

# Load the Ids we already decided to keep
